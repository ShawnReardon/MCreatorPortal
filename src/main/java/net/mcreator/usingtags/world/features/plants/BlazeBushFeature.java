...
public class BlazeBushFeature extends DefaultFlowerFeature {
	public static final BlazeBushFeature FEATURE = (BlazeBushFeature) new BlazeBushFeature().setRegistryName("usingtags:blaze_bush");
