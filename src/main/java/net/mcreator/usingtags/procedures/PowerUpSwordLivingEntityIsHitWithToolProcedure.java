...
public class PowerUpSwordLivingEntityIsHitWithToolProcedure {
	public static void execute(LevelAccessor world, Entity entity, ItemStack itemstack) {
		...
		if (Math.random() < 0.4) {
			...
			if (!world.isClientSide()) {
				...
				if (mcserv != null)
					mcserv.getPlayerList().broadcastMessage(new TextComponent(("DMG: " + 1)), ChatType.SYSTEM, Util.NIL_UUID);
			}
		} else {
